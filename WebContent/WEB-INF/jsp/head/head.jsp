...
$(document).ready(function(){
	$(document).scroll(function(){
        ...
        $("div#headernew").fadeIn(2000);
        $("div#rightnew").fadeIn(6000);
        $("div#rightnewtxt").fadeIn(9000);
        $("div#navUtilisater").fadeIn(9000);
    });
});
</script>  -->
...
<link href="css/wine-cellar.webflow.css" rel="stylesheet"
	type="text/css">
